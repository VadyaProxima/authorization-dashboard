            ...
            <div className="card-body">
              ...
              <div className="direct-chat-messages">
                ...
                <div className="direct-chat-msg right">
                  ...
                  {/* /.direct-chat-infos */}
                  <img className="direct-chat-img" src="/assets/user3-128x128.jpg" alt="message user image" />
                  {/* /.direct-chat-img */}
                  <div className="direct-chat-text">
              ...
              <div className="direct-chat-contacts">
                <ul className="contacts-list">
                  <li>
                    <a href="#">
                      <img className="contacts-list-img" src="/assets/user1-128x128.jpg" alt="User Avatar" />
                  ...
                  <li>
                    <a href="#">
                      <img className="contacts-list-img" src="/assets/user7-128x128.jpg" alt="User Avatar" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Sarah Doe
                  ...
                  <li>
                    <a href="#">
                      <img className="contacts-list-img" src="/assets/user3-128x128.jpg" alt="User Avatar" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Nadia Jolie
                  ...
                  <li>
                    <a href="#">
                      <img className="contacts-list-img" src="/assets/user5-128x128.jpg" alt="User Avatar" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Nora S. Vans
                  ...
                  <li>
                    <a href="#">
                      <img className="contacts-list-img" src="/assets/user6-128x128.jpg" alt="User Avatar" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          John K.
                  ...
                  <li>
                    <a href="#">
                      <img className="contacts-list-img" src="/assets/user8-128x128.jpg" alt="User Avatar" />
                      <div className="contacts-list-info">
                        <span className="contacts-list-name">
                          Kenneth M.
